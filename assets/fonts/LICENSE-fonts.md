...
- **License**: SIL Open Font License 1.1
- **Copyright**: Copyright © 2020 The Chakra Petch Project Authors (github.com/cadsondemak/chakra-petch)
...
- **License**: SIL Open Font License 1.1
- **Copyright**: Copyright © 2011 Brian J. Bonislawsky (astigmatic.com)
...
- **License**: SIL Open Font License 1.1
- **Copyright**: Copyright © 2016 The Oswald Project Authors (github.com/googlefonts/OswaldFont)
...
All SIL OFL 1.1 fonts require that copies include the above copyright notice
and this license. The Apache 2.0 fonts require retention of the copyright
notice. By documenting all fonts here with their copyright and license
information, this file satisfies the distribution requirements of both
licenses.

The full text of each license is available:
